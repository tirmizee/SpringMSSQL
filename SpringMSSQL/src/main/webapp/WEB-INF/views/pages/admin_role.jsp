  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="box-body">
        <form id="frmSearchRole" role="form">
          <div class="row">
          	<div class="col-md-6">
          	  <div class="form-group">
                <label>Role Name</label>
                <input name="provinceName" type="text" class="form-control"  placeholder="Role Name..">
              </div>
           	</div>
           	<div class="col-md-6">
          	  <div class="form-group">
                <label>Role Description</label>
                <input name="districtName" type="text" class="form-control"  placeholder="Role Description...">
              </div>
           	</div>
          </div>
