...
import com.tirmizee.jdbcrepository.sql.MssqlSqlGenerator;
...
public abstract class AbstractJdbcRepository<T extends Persistable<ID>, ID extends Serializable> implements JdbcRepository<T, ID>,InitializingBean{
	...
	public void afterPropertiesSet() throws Exception {
		...
		if (jdbcOperations == null) { jdbcOperations = new JdbcTemplate(dataSource); }
		if (sqlGenerator == null) { sqlGenerator = new MssqlSqlGenerator(); }
	}
